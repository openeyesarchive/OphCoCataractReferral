...
<div class="row field-row">
	...
	<div class="large-6 column end">
		<?php echo CHtml::activeDropDownList($element, $side.'_type_id', OphCoCataractReferral_Refraction_Type::model()->notDeletedOrPk($element->{$side.'_type_id'})->getOptions(), array('class' => 'refractionType'))?>
