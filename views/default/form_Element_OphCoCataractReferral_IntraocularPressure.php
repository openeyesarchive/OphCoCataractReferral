...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields element-eyes row">
		<div class="element-eye right-eye column">
			<div class="field-row">
				<?php echo $form->dropDownList($element, 'right_reading_id', CHtml::listData(OphCoCataractReferral_IntraocularPressure_Reading::model()->findAll(array('order'=>'display_order')),'id','name'), array('class' => 'inline iopReading', 'nowrapper'=>true))?>
		...
		<div class="element-eye left-eye column">
			<div class="field-row">
				<?php echo $form->dropDownList($element, 'left_reading_id', CHtml::listData(OphCoCataractReferral_IntraocularPressure_Reading::model()->findAll(array('order'=>'display_order')),'id','name'), array('class' => 'inline iopReading', 'nowrapper'=>true))?>
				<span class="unit">mmHg,</span>
				<?php if ($element->getSetting('show_instruments')) {
