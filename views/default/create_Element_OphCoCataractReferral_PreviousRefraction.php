...
<div class="element <?php echo $element->elementType->class_name ?>"
	...
	<div class="cols2 clearfix">
		...
		<?php echo $form->datePicker($element, 'previous_refraction_date', array('maxDate' => 'today'), array('hidden' => true))?>

		<div class="left eventDetail PreviousRefraction"<?php if (!@$_POST['Element_OphCoCataractReferral_PreviousRefraction']['previous_refraction_different']) {?> style="display: none;"<?php }?>>
			<div data-side="right">
				<?php
		...
		<div class="right eventDetail PreviousRefraction"<?php if (!@$_POST['Element_OphCoCataractReferral_PreviousRefraction']['previous_refraction_different']) {?> style="display: none;"<?php }?>>
			<div data-side="left">
				<?php
				$this->widget('application.modules.eyedraw.OEEyeDrawWidgetRefraction', array(
						'identifier' => 'PreviousRefraction',
