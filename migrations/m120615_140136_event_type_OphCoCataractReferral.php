	...
	public function up() {
		...
		$this->createTable('et_ophcocataractreferral_patientdetails', array(
			...
			'interpreter_id' => 'int(10) unsigned NOT NULL', // Interpreter
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `et_ophcocataractreferral_patientdetails_lmui_fk` (`last_modified_user_id`)',
				'KEY `et_ophcocataractreferral_patientdetails_cui_fk` (`created_user_id`)',
				'KEY `et_ophcocataractreferral_patientdetails_ev_fk` (`event_id`)',
								...
								'CONSTRAINT `et_ophcocataractreferral_patientdetails_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_patientdetails_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_patientdetails_ev_fk` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`)',
		...
		$this->createTable('et_ophcocataractreferral_hpc', array(
			...
			'first_second_eye_id' => 'int(10) unsigned NOT NULL', // 1st 2nd eye
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `et_ophcocataractreferral_hpc_lmui_fk` (`last_modified_user_id`)',
				'KEY `et_ophcocataractreferral_hpc_cui_fk` (`created_user_id`)',
				'KEY `et_ophcocataractreferral_hpc_ev_fk` (`event_id`)',
								...
								'CONSTRAINT `et_ophcocataractreferral_hpc_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_hpc_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_hpc_ev_fk` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`)',
		...
		$this->createTable('et_ophcocataractreferral_intraocularpressure', array(
			...
			'right_pressure_id' => 'int(10) unsigned NOT NULL', // Right pressure
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `et_ophcocataractreferral_intraocularpressure_lmui_fk` (`last_modified_user_id`)',
				'KEY `et_ophcocataractreferral_intraocularpressure_cui_fk` (`created_user_id`)',
				'KEY `et_ophcocataractreferral_intraocularpressure_ev_fk` (`event_id`)',
								...
								'CONSTRAINT `et_ophcocataractreferral_intraocularpressure_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_intraocularpressure_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `et_ophcocataractreferral_intraocularpressure_ev_fk` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`)',
		...
		$this->createTable('et_ophcocataractreferral_posteriorsegment', array(
			...
			'left_eye' => 'text NOT NULL', // Left eye
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `et_ophcocataractreferral_posteriorsegment_lmui_fk` (`last_modified_user_id`)',
				'KEY `et_ophcocataractreferral_posteriorsegment_cui_fk` (`created_user_id`)',
				'KEY `et_ophcocataractreferral_posteriorsegment_ev_fk` (`event_id`)',
		...
		$this->createTable('et_ophcocataractreferral_confirmation', array(
			...
			'consider_surgery' => 'tinyint(1) unsigned NOT NULL', // Patient wishes to consider cataract surgery
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `et_ophcocataractreferral_confirmation_lmui_fk` (`last_modified_user_id`)',
				'KEY `et_ophcocataractreferral_confirmation_cui_fk` (`created_user_id`)',
				'KEY `et_ophcocataractreferral_confirmation_ev_fk` (`event_id`)',
