...
/**
 * This is the model class for table "ophcocataractreferral_visual_acuity_unit".
 *
 * @property integer $id
 * @property string $name
 */
class OphCoCataractReferral_VisualAcuityUnit extends BaseActiveRecordVersionedSoftDelete
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return OphCoCataractReferral_VisualAcuityUnit the static model class
	 */
