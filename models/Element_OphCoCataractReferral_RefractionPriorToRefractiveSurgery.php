...
class Element_OphCoCataractReferral_RefractionPriorToRefractiveSurgery extends BaseEventTypeElement
{
	...
	public function rules()
	{
		...
		return array(
			array('event_id, right_sphere, right_cylinder, right_axis, right_axis_eyedraw, right_refraction_type_id, left_sphere, left_cylinder, left_axis, left_axis_eyedraw, left_refraction_type_id, refractive_surgery, refractive_surgery_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, event_id, right_cylinder, right_axis, right_axis_eyedraw, right_refraction_type_id, left_sphere, left_cylinder, left_axis, left_axis_eyedraw, left_refraction_type_id, refractive_surgery, refractive_surgery_date', 'safe', 'on' => 'search'),
		);
	}
